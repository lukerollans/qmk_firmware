...
[0] = LAYOUT_60_ansi( /* Base */
    ...
    KC_LCTL,  KC_LALT,  KC_LGUI,                       KC_SPC,                          KC_RALT,  MO(1)  ,  KC_APP,  KC_RCTL),

[1] = LAYOUT_60_ansi( /* FN */
    KC_GRV,   KC_MEDIA_REWIND,    KC_MEDIA_PLAY_PAUSE,    KC_MEDIA_FAST_FORWARD,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL ,\
    KC_TRNS,  KC_TRNS,  KC_UP,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  RESET,    KC_TRNS,\
    KC_TRNS,  KC_LEFT,  KC__VOLDOWN,  KC__VOLUP,  S1_DEC,   S1_INC,   S2_DEC,   S2_INC,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,\
